...
class TDDFA(object):
    ...
    def __init__(self, **kvs):
        ...
        param_mean_std_fp = kvs.get('param_mean_std_fp', make_abs_path(f'configs/param_mean_std_62d_{self.size}x{self.size}.pkl'))
    ...
    def __call__(self, img_ori,objs, **kvs):
        ...
        img = cv2.resize(img_ori, dsize=(self.size, self.size), interpolation=cv2.INTER_LINEAR)
